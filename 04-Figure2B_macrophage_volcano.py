#!/usr/bin/env python3
"""Figure 2B: Post-treatment macrophage DGE volcano plot."""
...
INPUT = "posttreatment_macrophage_DGE_results.csv"
OUTPUT = "Figure2B_macrophage_volcano_posttreatment"
FDR, LFC = 0.05, 0.5
...
ax.set_title(f"Post-treatment Macrophages\n{n_p + n_np} DEGs (FDR<0.05, |log\u2082FC|>0.5)",
